    ...
    <div class="container">
        ...
        <form class="form-horizontal" action="{{route('register-user')}}" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="textbox" class="form-control" id="firstname" name="firstname" placeholder="Enter firstname">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="textbox" class="form-control" id="lastname" name="lastname" placeholder="Enter lastname">
        ...
        <!-- 	<div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <textarea id="address" name="address" placeholder="Enter address" class="form-control" rows="5" title ="Please enter Address with Pincode"></textarea>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="textbox" id="mobileno" placeholder="Enter mobile number" class="form-control" name="mobileno" title ="Please enter 10 digit mobileno.">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="email" id="emailid" name="email" placeholder="Enter email id" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="password"  class="form-control" placeholder="Enter password" name="password" id = "pass1">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="password"  name="repassword" placeholder="Confirm password" id = "pass2" class="form-control" onkeyup="checkPass(); return false;">		
